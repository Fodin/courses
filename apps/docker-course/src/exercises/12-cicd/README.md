...
│                  Ручной деплой                          │
│                                                         │
│  Разработчик ──► git push ──► SSH на сервер ──► build  │
│       │                            │                    │
│       │         Человеческий       │                    │
│       │           фактор:          │                    │
│       │                            │                    │
│       │  • Забыл запустить тесты   │                    │
│       │  • Собрал не ту ветку      │                    │
│       │  • Не обновил .env         │                    │
│       │  • Забыл про миграции      │                    │
│       │  • Нет rollback-плана      │                    │
...
│                  │           │           │            │   │
│                  ▼           ▼           ▼            ▼   │
│             Автоматически  Гарантия  Версионный  Безопас- │
│             воспроизводимо качества  контроль    ный      │
│                                      образов    rollback │
└──────────────────────────────────────────────────────────┘
```
...
Реплика 1:  [v1] [v1] [v2] [v2] [v2]
Реплика 2:  [v1] [v1] [v1] [v2] [v2]
Реплика 3:  [v1] [v1] [v1] [v1] [v2]

Трафик:     100%v1     mixed     100%v2
```
...
```
┌──────────────┐     ┌──────────────┐
│  Load Balancer│────►│  Blue (v1)   │  ◄── текущий production
│              │     │  Port 8080   │
│              │     └──────────────┘
│              │
│              │     ┌──────────────┐
│              │     │  Green (v2)  │  ◄── новая версия (тестируется)
│              │     │  Port 8081   │
│              │     └──────────────┘
└──────────────┘

# После проверки green -- переключаем трафик:
# Load Balancer ──► Green (v2) [новый production]
# Blue (v1) -- оставляем для быстрого rollback
```
