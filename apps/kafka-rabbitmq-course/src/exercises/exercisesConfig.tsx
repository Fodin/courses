...
import * as Level0 from './00-microservices-intro'
import * as Level1 from './01-sync-communication'
import * as Level2 from './02-async-messaging'
import * as Level3 from './03-broker-fundamentals'
import * as Level4 from './04-rabbitmq-basics'
import * as Level5 from './05-rabbitmq-exchanges'
import * as Level6 from './06-rabbitmq-reliability'
import * as Level7 from './07-rabbitmq-advanced'
import * as Level8 from './08-kafka-basics'
import * as Level9 from './09-kafka-producers-consumers'
import * as Level10 from './10-kafka-advanced'
import * as Level11 from './11-broker-comparison'
import * as Level12 from './12-event-driven-patterns'
import * as Level13 from './13-saga-pattern'
import * as Level14 from './14-reliability-patterns'
import * as Level15 from './15-exactly-once-outbox'
import * as Level16 from './16-observability'
import * as Level17 from './17-real-world-architectures'

export const exercises: LevelConfig[] = [
  {
    levelId: '0',
    folder: '00-microservices-intro',
    navKey: 'nav.microservicesIntro',
  ...
  {
    levelId: '1',
    folder: '01-sync-communication',
    navKey: 'nav.syncCommunication',
  ...
  {
    levelId: '2',
    folder: '02-async-messaging',
    navKey: 'nav.asyncMessaging',
  ...
  {
    levelId: '3',
    folder: '03-broker-fundamentals',
    navKey: 'nav.brokerFundamentals',
  ...
  {
    levelId: '4',
    folder: '04-rabbitmq-basics',
    navKey: 'nav.rabbitmqBasics',
  ...
  {
    levelId: '5',
    folder: '05-rabbitmq-exchanges',
    navKey: 'nav.rabbitmqExchanges',
  ...
  {
    levelId: '6',
    folder: '06-rabbitmq-reliability',
    navKey: 'nav.rabbitmqReliability',
  ...
  {
    levelId: '7',
    folder: '07-rabbitmq-advanced',
    navKey: 'nav.rabbitmqAdvanced',
  ...
  {
    levelId: '8',
    folder: '08-kafka-basics',
    navKey: 'nav.kafkaBasics',
  ...
  {
    levelId: '9',
    folder: '09-kafka-producers-consumers',
    navKey: 'nav.kafkaProducersConsumers',
  ...
  {
    levelId: '10',
    folder: '10-kafka-advanced',
    navKey: 'nav.kafkaAdvanced',
  ...
  {
    levelId: '11',
    folder: '11-broker-comparison',
    navKey: 'nav.brokerComparison',
  ...
  {
    levelId: '12',
    folder: '12-event-driven-patterns',
    navKey: 'nav.eventDriven',
  ...
  {
    levelId: '13',
    folder: '13-saga-pattern',
    navKey: 'nav.sagaPattern',
  ...
  {
    levelId: '14',
    folder: '14-reliability-patterns',
  ...
  {
    levelId: '15',
    folder: '15-exactly-once-outbox',
    navKey: 'nav.exactlyOnceOutbox',
  ...
  {
    levelId: '17',
    folder: '17-real-world-architectures',
    navKey: 'nav.realWorldArchitectures',
