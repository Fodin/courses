...
// ============================================
// Задание 8.1: window.onerror — Решение
// ============================================
...
export function Task8_1_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 8.1: window.onerror</h2>
...
// ============================================
// Задание 8.2: Сервис логирования — Решение
// ============================================
...
export function Task8_2_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 8.2: Сервис логирования</h2>
...
// ============================================
// Задание 8.3: React Error Context — Решение
// ============================================
...
export function Task8_3_Solution() {
  return (
    <div className="exercise-container">
      <h2>Задание 8.3: React Error Context</h2>
      <ErrorProvider>
        <ErrorDisplay />
        <DemoComponent />
      </ErrorProvider>
...
// ============================================
// Задание 8.4: Мониторинг ошибок — Решение
// ============================================
...
export function Task8_4_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 8.4: Мониторинг ошибок</h2>
      <div style={{ display: 'flex', gap: '0.5rem', marginBottom: '1rem' }}>
