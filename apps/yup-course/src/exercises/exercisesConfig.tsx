...
import * as Level1 from './01-primitives'
import * as Level2 from './02-strings'
import * as Level3 from './03-numbers-dates'
import * as Level4 from './04-objects'
import * as Level5 from './05-arrays-tuples'
import * as Level6 from './06-conditional'
import * as Level7 from './07-custom-transforms'
...
export const exercises: LevelConfig[] = [
  ...
  {
    levelId: '1',
    folder: '01-primitives',
    navKey: 'nav.primitives',
  ...
  {
    levelId: '6',
    folder: '06-conditional',
    navKey: 'nav.conditional',
