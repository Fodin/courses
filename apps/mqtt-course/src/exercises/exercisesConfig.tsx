...
import * as Level1 from './01-installation'
import * as Level2 from './02-configuration'
import * as Level3 from './03-topics'
import * as Level4 from './04-qos'
import * as Level5 from './05-auth'
import * as Level6 from './06-tls'
import * as Level7 from './07-persistence'
import * as Level8 from './08-bridge'
import * as Level9 from './09-websockets'
import * as Level10 from './10-monitoring'
import * as Level11 from './11-optimization'
...
export const exercises: LevelConfig[] = [
  ...
  {
    levelId: '1',
    folder: '01-installation',
    navKey: 'nav.installation',
  ...
  {
    levelId: '2',
    folder: '02-configuration',
    navKey: 'nav.configuration',
  ...
  {
    levelId: '7',
    folder: '07-persistence',
    navKey: 'nav.persistence',
  ...
  {
    levelId: '9',
    folder: '09-websockets',
    navKey: 'nav.websockets',
