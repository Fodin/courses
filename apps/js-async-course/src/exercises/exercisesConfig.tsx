...
import * as Level0 from './00-call-stack'
import * as Level1 from './01-event-loop'
import * as Level2 from './02-callbacks'
import * as Level3 from './03-promise-basics'
import * as Level4 from './04-promise-chains'
import * as Level5 from './05-promise-combinators'
import * as Level6 from './06-async-await'
import * as Level7 from './07-async-patterns'
import * as Level8 from './08-generators'
import * as Level9 from './09-async-generators'
import * as Level10 from './10-abort-controller'
import * as Level11 from './11-raf-ric'
import * as Level12 from './12-web-workers'
import * as Level13 from './13-shared-memory'
import * as Level14 from './14-real-world'

export const exercises: LevelConfig[] = [
  {
    levelId: '0',
    folder: '00-call-stack',
    navKey: 'nav.callStack',
  ...
  {
    levelId: '3',
    folder: '03-promise-basics',
    navKey: 'nav.promiseBasics',
  ...
  {
    levelId: '4',
    folder: '04-promise-chains',
    navKey: 'nav.promiseChains',
  ...
  {
    levelId: '5',
    folder: '05-promise-combinators',
    navKey: 'nav.promiseCombinators',
  ...
  {
    levelId: '7',
    folder: '07-async-patterns',
    navKey: 'nav.asyncPatterns',
  ...
  {
    levelId: '8',
    folder: '08-generators',
    navKey: 'nav.generators',
  ...
  {
    levelId: '9',
    folder: '09-async-generators',
    navKey: 'nav.asyncGenerators',
  ...
  {
    levelId: '10',
    folder: '10-abort-controller',
    navKey: 'nav.abortController',
  ...
  {
    levelId: '12',
    folder: '12-web-workers',
    navKey: 'nav.webWorkers',
  ...
  {
    levelId: '13',
    folder: '13-shared-memory',
    navKey: 'nav.sharedMemory',
