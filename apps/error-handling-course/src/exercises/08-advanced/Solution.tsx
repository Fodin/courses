...
// ============================================
// Задание 8.1: Функциональная обработка — Решение
// ============================================
...
export function Task8_1_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 8.1: Функциональная обработка</h2>
...
// ============================================
// Задание 8.2: Тестирование ошибок — Решение
// ============================================
...
export function Task8_2_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 8.2: Тестирование ошибок</h2>
...
// ============================================
// Задание 8.3: Финальный проект — Решение
// ============================================
...
export function Task8_3_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 8.3: Финальный проект — Todo с обработкой ошибок</h2>
