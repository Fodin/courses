...
// ============================================
// Задание 6.1: Ошибки fetch — Решение
// ============================================
...
export function Task6_1_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 6.1: Ошибки fetch</h2>
...
// ============================================
// Задание 6.2: API ошибки — Решение
// ============================================
...
// ============================================
// Задание 6.3: Loading/Error/Success — Решение
// ============================================
...
export function Task6_3_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 6.3: Loading/Error/Success</h2>
...
// ============================================
// Задание 6.4: Восстановление загрузки — Решение
// ============================================
...
export function Task6_4_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 6.4: Восстановление загрузки</h2>
