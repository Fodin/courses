...
// ============================================
// Задание 7.1: Ошибки валидации — Решение
// ============================================
...
export function Task7_1_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 7.1: Ошибки валидации</h2>
...
// ============================================
// Задание 7.2: Серверные ошибки — Решение
// ============================================
...
export function Task7_2_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 7.2: Серверные ошибки</h2>
...
// ============================================
// Задание 7.3: Отображение ошибок — Решение
// ============================================
...
export function Task7_3_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 7.3: Отображение ошибок</h2>
...
// ============================================
// Задание 7.4: Доступность ошибок — Решение
// ============================================
...
export function Task7_4_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 7.4: Доступность ошибок</h2>
