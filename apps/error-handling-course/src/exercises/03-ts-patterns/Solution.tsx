...
// ============================================
// Задание 3.1: Result тип — Решение
// ============================================
...
// ============================================
// Задание 3.2: Discriminated unions — Решение
// ============================================
...
export function Task3_2_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 3.2: Discriminated unions</h2>
...
// ============================================
// Задание 3.3: Type-safe ошибки — Решение
// ============================================
...
export function Task3_3_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 3.3: Type-safe ошибки</h2>
      <button onClick={runExamples}>Запустить</button>
      {results.length > 0 && (
        <div style={{ marginTop: '1rem' }}>
...
// ============================================
// Задание 3.4: Exhaustive handling — Решение
// ============================================
...
export function Task3_4_Solution() {
  ...
  return (
    <div className="exercise-container">
      <h2>Задание 3.4: Exhaustive handling</h2>
      <button onClick={runExamples}>Запустить</button>
      {results.length > 0 && (
        <div style={{ marginTop: '1rem' }}>
          <h3>Результаты:</h3>
