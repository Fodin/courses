...
import * as Level0 from './00-type-contracts'
import * as Level1 from './01-creational'
import * as Level2 from './02-structural'
import * as Level3 from './03-behavioral'
import * as Level4 from './04-composition'
import * as Level5 from './05-data-management'
import * as Level6 from './06-error-results'
import * as Level7 from './07-modular-architecture'
import * as Level8 from './08-advanced-ts'

export const exercises: LevelConfig[] = [
  {
    levelId: '0',
    folder: '00-type-contracts',
    navKey: 'nav.typeContracts',
  ...
  {
    levelId: '1',
    folder: '01-creational',
    navKey: 'nav.creational',
  ...
  {
    levelId: '3',
    folder: '03-behavioral',
    navKey: 'nav.behavioral',
  ...
  {
    levelId: '4',
    folder: '04-composition',
    navKey: 'nav.composition',
  ...
  {
    levelId: '6',
    folder: '06-error-results',
    navKey: 'nav.errorResults',
  ...
  {
    levelId: '7',
    folder: '07-modular-architecture',
    navKey: 'nav.modular',
  ...
  {
    levelId: '8',
    folder: '08-advanced-ts',
    navKey: 'nav.advancedTs',
