    ...
    <div className="exercise-container" style={{ padding: '1.5rem', maxWidth: '1000px' }}>
      ...
      {/* TODO: Cards mode (mode === 'cards'):
           ...
           Tool card:
             ...
             - Yellow block: "Когда использовать: ..."
             - Toggle button: "Показать/Скрыть пример настройки"
             - Code block (bg #0f172a): config text, shown when toggled */}

      {/* TODO: Table mode (mode === 'table'):
           Comparison table with rows for each criterion and columns for each tool
           Criteria rows:
             Try it out, Mock-сервер, Дизайн, Open Source, Self-host,
             Совместная работа, Design-first, Сложность настройки, Цена
