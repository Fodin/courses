...
import * as Level0 from './00-decomposition'
import * as Level1 from './01-composition-basics'
import * as Level2 from './02-render-props'
import * as Level3 from './03-compound-components'
import * as Level4 from './04-hoc'
import * as Level5 from './05-context-architecture'
import * as Level6 from './06-context-state'
import * as Level7 from './07-hooks-architecture'
import * as Level8 from './08-render-optimization'
import * as Level9 from './09-component-api'
import * as Level10 from './10-layout-patterns'
import * as Level11 from './11-error-handling'
import * as Level12 from './12-advanced-patterns'

export const exercises: LevelConfig[] = [
  {
    levelId: '0',
    folder: '00-decomposition',
    navKey: 'nav.decomposition',
  ...
  {
    levelId: '1',
    folder: '01-composition-basics',
    navKey: 'nav.compositionBasics',
  ...
  {
    levelId: '2',
    folder: '02-render-props',
    navKey: 'nav.renderProps',
  ...
  {
    levelId: '3',
    folder: '03-compound-components',
    navKey: 'nav.compoundComponents',
  ...
  {
    levelId: '5',
    folder: '05-context-architecture',
    navKey: 'nav.contextArchitecture',
  ...
  {
    levelId: '6',
    folder: '06-context-state',
    navKey: 'nav.contextState',
  ...
  {
    levelId: '7',
    folder: '07-hooks-architecture',
    navKey: 'nav.hooksArchitecture',
  ...
  {
    levelId: '8',
    folder: '08-render-optimization',
    navKey: 'nav.renderOptimization',
  ...
  {
    levelId: '9',
    folder: '09-component-api',
    navKey: 'nav.componentApi',
  ...
  {
    levelId: '10',
    folder: '10-layout-patterns',
    navKey: 'nav.layoutPatterns',
  ...
  {
    levelId: '12',
    folder: '12-advanced-patterns',
    navKey: 'nav.advancedPatterns',
